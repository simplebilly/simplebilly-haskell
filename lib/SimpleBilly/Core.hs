...
module SimpleBilly.Core where

import SimpleBilly.MimeTypes
import SimpleBilly.Logging
...
-- |
data SimpleBillyConfig = SimpleBillyConfig
...
-- | display the config
instance P.Show SimpleBillyConfig where
  show c =
    T.printf
...
-- | constructs a default SimpleBillyConfig
--
-- configHost:
--
...
-- @"simplebilly/0.1.0.0"@
--
newConfig :: IO SimpleBillyConfig
newConfig = do
    logCxt <- initLogContext
    return $ SimpleBillyConfig
        { configHost = "https://demo.simplebilly.com"
        , configUserAgent = "simplebilly/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => SimpleBillyConfig -> auth -> SimpleBillyConfig
addAuthMethod config@SimpleBillyConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: SimpleBillyConfig -> IO SimpleBillyConfig
...
withStderrLogging :: SimpleBillyConfig -> IO SimpleBillyConfig
...
withNoLogging :: SimpleBillyConfig -> SimpleBillyConfig
...
data SimpleBillyRequest req contentType res accept = SimpleBillyRequest
  { rMethod  :: NH.Method   -- ^ Method of SimpleBillyRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of SimpleBillyRequest
  , rParams   :: Params -- ^ params of SimpleBillyRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (SimpleBillyRequest req contentType res accept) NH.Method
rMethodL f SimpleBillyRequest{..} = (\rMethod -> SimpleBillyRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (SimpleBillyRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f SimpleBillyRequest{..} = (\rUrlPath -> SimpleBillyRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (SimpleBillyRequest req contentType res accept) Params
rParamsL f SimpleBillyRequest{..} = (\rParams -> SimpleBillyRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (SimpleBillyRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f SimpleBillyRequest{..} = (\rAuthTypes -> SimpleBillyRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => SimpleBillyRequest req contentType res accept -> param -> SimpleBillyRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: SimpleBillyRequest req contentType res accept -> param -> SimpleBillyRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: SimpleBillyRequest req contentType res accept -> param -> SimpleBillyRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** SimpleBillyRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> SimpleBillyRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = SimpleBillyRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     SimpleBillyRequest req contentType res accept
  -> [NH.Header]
  -> SimpleBillyRequest req contentType res accept
...
removeHeader :: SimpleBillyRequest req contentType res accept -> [NH.HeaderName] -> SimpleBillyRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => SimpleBillyRequest req contentType res accept -> SimpleBillyRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => SimpleBillyRequest req contentType res accept -> SimpleBillyRequest req contentType res accept
...
addForm :: SimpleBillyRequest req contentType res accept -> WH.Form -> SimpleBillyRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: SimpleBillyRequest req contentType res accept -> NH.Part -> SimpleBillyRequest req contentType res accept
...
_setBodyBS :: SimpleBillyRequest req contentType res accept -> B.ByteString -> SimpleBillyRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: SimpleBillyRequest req contentType res accept -> BL.ByteString -> SimpleBillyRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => SimpleBillyRequest req contentType res accept -> P.Proxy authMethod -> SimpleBillyRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> SimpleBillyRequest req contentType res accept
    -> IO (SimpleBillyRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> SimpleBillyConfig
  -> IO (SimpleBillyRequest req contentType res accept)
_applyAuthMethods req config@(SimpleBillyConfig {configAuthMethods = as}) =
  foldlM go req as
  where
