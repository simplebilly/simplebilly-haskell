...
module SimpleBilly.MimeTypes where
...
data MimeZip = MimeZip deriving (P.Typeable)

-- | @application/zip@
instance MimeType MimeZip where
  mimeType _ = Just $ P.fromString "application/zip"
-- instance MimeRender MimeZip T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeZip T.Text where mimeUnrender _ = undefined
