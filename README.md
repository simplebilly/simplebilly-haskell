# SimpleBilly Haskell SDK

[![Release](https://img.shields.io/github/v/release/simplebilly/simplebilly-haskell?label=release&logo=github)](https://github.com/simplebilly/simplebilly-haskell/releases)
[![CI](https://github.com/simplebilly/simplebilly-haskell/actions/workflows/release.yml/badge.svg)](https://github.com/simplebilly/simplebilly-haskell/actions/workflows/release.yml)
[![CodeQL](https://github.com/simplebilly/simplebilly-haskell/actions/workflows/codeql.yml/badge.svg)](https://github.com/simplebilly/simplebilly-haskell/actions/workflows/codeql.yml)
[![Scorecard](https://github.com/simplebilly/simplebilly-haskell/actions/workflows/scorecard.yml/badge.svg)](https://github.com/simplebilly/simplebilly-haskell/actions/workflows/scorecard.yml)
[![OpenSSF Scorecard](https://api.scorecard.dev/projects/github.com/simplebilly/simplebilly-haskell/badge)](https://scorecard.dev/viewer/?uri=github.com/simplebilly/simplebilly-haskell)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Docs](https://img.shields.io/badge/docs-simplebilly.com-blue)](https://simplebilly.com/api/docs)
## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `SimpleBilly API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the SimpleBilly API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | SimpleBilly                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | simplebilly                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | SimpleBillyConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | SimpleBillyRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| SimpleBilly.Client    | use the "dispatch" functions to send requests       |
| SimpleBilly.Core      | core functions, config and request types            |
| SimpleBilly.API       | construct api requests                              |
| SimpleBilly.Model     | describes api models                                |
| SimpleBilly.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| SimpleBilly.ModelLens | lenses for model fields                             |
| SimpleBilly.Logging   | logging functions and utils                         |
